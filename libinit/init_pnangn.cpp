...
void vendor_load_properties() {
    ...
    if (sku == "XT2201-1") {
        load_device_properties("pnangn-user 13 S3SHS32.12-42-11-5 bf0951", "motorola/pnangn/pnangn:12/S3SHS32.12-42-11-5/bf0951:user/release-keys", "pnangn", "Motorola Edge 30 Pro");
    }
    else if (sku == "XT2201-2") {
        load_device_properties("pnangnd-user 13 S3SF32.35-5-9 37351", "motorola/pnangnd/pnangnd:12/S3SF32.35-5-9/37351:user/release-keys", "pnangnd", "Motorola Edge X30");
    }
    else {
        load_device_properties("pnangnc-user 13 S3SC32.7-42-20 02af5", "motorola/pnangnc/pnangnc:12/S3SC32.7-42-20/02af5:user/release-keys", "pnangnc", "Motorola Edge X30");
   }
}
